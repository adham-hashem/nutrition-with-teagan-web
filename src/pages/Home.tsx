...
import { ArrowRight, Star, Leaf, CheckCircle2, Sparkles } from 'lucide-react';
...
export default function Home() {
  ...
  const [recentTestimonials, setRecentTestimonials] = useState(testimonials);
  ...
  return (
    <div className="overflow-x-hidden">
      {/* ─── HERO ─── */}
      <section className="relative min-h-screen flex items-center pt-28 pb-20 px-6" style={{ background: '#FAF8F3' }}>
        {/* Decorative botanical blobs - Reduced for cleaner mobile look */}
        <div className="absolute top-20 right-0 w-[500px] h-[500px] rounded-full pointer-events-none hidden md:block" style={{ background: 'radial-gradient(circle, #9C8AB8 0%, transparent 70%)', transform: 'translate(30%, -20%)', opacity: 0.2 }} />
        <div className="absolute bottom-0 left-0 w-[300px] h-[300px] rounded-full pointer-events-none hidden md:block" style={{ background: 'radial-gradient(circle, #8A9C7A 0%, transparent 70%)', transform: 'translate(-30%, 30%)', opacity: 0.18 }} />
        ...
        <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center gap-2 rounded-full px-4 py-2 mb-8" style={{ background: 'rgba(138, 156, 122, 0.12)', border: '2px solid #8A9C7A' }}>
            ...
            <h1 className="font-playfair text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.12] text-text-heading mb-6">
              Restore Balance<br />
              <em className="text-sage not-italic">Through</em> Personalised<br />
              Naturopathic Nutrition
            </h1>

            <p className="font-montserrat text-base md:text-lg font-medium text-text-body leading-[1.8] mb-10 max-w-lg">
            ...
            {/* Social proof */}
            <div className="flex items-center gap-6 pt-6" style={{ borderTop: '2px solid #8A9C7A' }}>
          ...
          <div className="relative hidden lg:block">
            <div className="relative z-10 rounded-[2.5rem] overflow-hidden shadow-luxury">
              <img
            ...
            {/* Floating badge */}
            <div className="absolute -bottom-6 -left-8 bg-white rounded-2xl p-5 shadow-card z-20 max-w-[200px]">
            ...
            {/* Floating badge 2 */}
            <div className="absolute -top-6 -right-4 rounded-2xl p-4 shadow-soft z-20" style={{ background: 'rgba(169, 153, 194, 0.18)', border: '2px solid #A999C2' }}>
      ...
      {/* ─── SPECIALISATIONS ─── */}
      <section className="py-24 px-6" style={{ background: '#F4EFE6' }}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {specialisations.map((spec, i) => (
              <ScrollReveal key={spec.title} delay={i * 100}>
                <div className="group bg-white rounded-3xl p-8 shadow-card hover:shadow-card-hover hover:-translate-y-1 transition-all duration-500 h-full flex flex-col">
                  <div
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <ScrollReveal>
            <div className="relative">
              ...
              <div className="absolute top-8 -right-6 rounded-2xl p-5 shadow-soft max-w-[180px]" style={{ background: 'rgba(169, 153, 194, 0.2)', border: '1.5px solid rgba(139, 122, 171, 0.35)' }}>
              ...
              <div className="absolute -bottom-6 left-8 bg-white rounded-2xl p-5 shadow-luxury">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              <ScrollReveal key={program.title} delay={i * 100}>
                <div className="group bg-white rounded-3xl overflow-hidden shadow-card hover:shadow-card-hover hover:-translate-y-1 transition-all duration-500">
                  ...
                  <div className="p-8">
                    ...
                    <div className="flex gap-3">
                      ...
                      <Link to="/booking" className="btn-primary text-xs px-5 py-3">
                        Book Now
                      </Link>
                    </div>
                  </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {recentArticles.map((article, i) => (
              <ScrollReveal key={article.title} delay={i * 100}>
                <Link to="/blog" className="group block bg-white rounded-3xl overflow-hidden shadow-card hover:shadow-card-hover hover:-translate-y-1 transition-all duration-500">
